...
The script have two function and contains the function that calls the EIA API and 
put the data in to the CSV file located in chanllenge_data_wrangling/data/daily_gas_prices.csv \
with this data.
"""
...
def get_list_of_data(duration_type = "annually"):
    ...
    URL  = B_URL + series_id.get(duration_type,"daily")
...
def csv_file( duration_type="daily",filepath=None):
    ...
    path = 'data/{}_gas_prices.csv'.format(duration_type)
